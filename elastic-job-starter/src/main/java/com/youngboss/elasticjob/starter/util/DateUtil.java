...
public final class DateUtil {
	...
	public static void main(String[] args) {
		Date beginTimeOfDate = DateUtil.getBeginTimeOfDate(new Date());
		System.out.println(beginTimeOfDate.toLocaleString());
		Date endTimeOfDate = DateUtil.getEndTimeOfDate(new Date());
		System.out.println(endTimeOfDate.toLocaleString());
	}

	public static boolean isFirstDayOfYear() {
		return "0101".equals(DateUtil.formatDate(new Date(), "MMdd"));
	}
}