...
/*********************DataflowJobConfiguration START********************/
	 ...
	 * @return
	 */
	private Class<? extends AbstractDistributeOnceElasticJobListener> distributedListener = CommonScheduleJobListener.class;
	...
	public Job setJobParameterVo(JobParameterVo jobParameterVo) {
		this.jobParameterVo = jobParameterVo;
		this.jobParameter = jobParameterVo.toJson();
		return this;
	}

	public Job parseParameter() {
		jobParameterVo = JSONObject.parseObject(jobParameter, JobParameterVo.class);
		return this;
	}
}
