...
public @interface JobConfEnum {
	 ...
	 * 任务类路径
	 */
	Class<? extends ElasticJob> jobClass();
	 ...
	 * @return
	 */
	Class<? extends AbstractDistributeOnceElasticJobListener> distributedListener() default CommonScheduleJobListener.class;
